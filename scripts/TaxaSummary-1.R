...
shapiro.test(as.numeric(otu_taxa3$CHRONIC_CONDITION=='n'))
wilcox.test(as.numeric(otu_taxa3$CHRONIC_CONDITION=='n'), as.numeric(otu_taxa3$CHRONIC_CONDITION=='y'), na.rm=TRUE)
